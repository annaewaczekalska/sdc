...
1. **Przygotowanie procedury**\
   ☐ Sformalizować procedurę w formie dokumentu (cel, zakres, etapy, odpowiedzialności).\
   ☐ Załączyć formularz wniosku o dostosowanie cyfrowe.\
   ☐ Przygotować uzasadnienia procedury w trzech wersjach: oficjalna, skrócona, przystępna dla pracowników.\
   ☐ Zamieścić listę źródeł i standardów (np. WCAG, ISO, przepisy krajowe).
2. **Komunikacja z pracownikami**\
   ☐ Przekazać procedurę pracownikom w intranecie, e-mailu lub podczas spotkania informacyjnego.\
...
6. **Monitorowanie i doskonalenie**\
   ...
   ☐ Ocenić skuteczność działań i identyfikować obszary do poprawy.\
   ☐ Aktualizować procedurę i szkolenia na podstawie doświadczeń i zmian w przepisach.
7. **Dokumentacja**\
   ☐ Prowadzić rejestr wszystkich zgłoszeń i wdrożonych dostosowań.\
   ☐ Przechowywać dokumentację zgodnie z przepisami o ochronie danych osobowych.\
   ☐ Sporządzać raporty okresowe dla zarządu lub audytu wewnętrznego.
