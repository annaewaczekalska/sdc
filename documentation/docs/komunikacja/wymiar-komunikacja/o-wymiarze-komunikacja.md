...
<!-- 
- **Planowanie komunikacji** – zasady, standardy i odpowiedzialności dotyczące dostępnej komunikacji wewnętrznej i zewnętrznej.  
- **Tworzenie treści dostępnych cyfrowo** – teksty, dokumenty, multimedia, grafiki, formularze, treści w mediach społecznościowych.  
- **Publikacja i dystrybucja treści** – procesy zapewniające, że publikowane materiały spełniają wymagania dostępności.  
- **Dostosowanie kanałów komunikacji** – zapewnienie wielokanałowego, dostępnego przekazu (WWW, media społecznościowe, e-usługi, e-mail, materiały drukowane w alternatywnych formatach).  
- **Standaryzacja i narzędzia** – stosowanie szablonów, instrukcji, wytycznych, stylów oraz narzędzi wspierających dostępność.  
- **Język i forma przekazu** – stosowanie języka prostego, komunikacji zorientowanej na użytkownika oraz zasad czytelności.  
- **Informowanie o dostępności** – jasne komunikowanie możliwości kontaktu, zgłaszania problemów, sposobów uzyskania wsparcia oraz dostępnych dostosowań.  
...
![Zasady i procedury komunikacji](/img/komunikacja-03.svg)
...
![Dostępna treść komunikacyjna](/img/komunikacja-02.svg)
...
![Dostępne kanały komunikacji](/img/komunikacja-01.svg)
...
![Monitorowanie i doskonalenie komunikacji](/img/komunikacja-04.svg)
