...
3. **W-03. Tworzenie treści. Dostawca opisze, w jaki sposób rozwiązanie wspiera tworzenie dostępnych treści cyfrowych i zapewnia ich zgodność z WCAG. Dostawca określi, które elementy dostępności są zapewniane przez system, a które zależą od sposobu tworzenia treści przez użytkowników.**<br/><br/>
...
Deklaracja powinna być oparta na rzeczywistych wynikach testów i stanowić podstawę do weryfikacji spełnienia wymagań dostępności. Warunkiem wstępnym jest przedstawienie przez dostawcę wystarczających dowodów testów zgodności z WCAG, na podstawie których można uzyskać szczegółowe informacje wymagane w deklaracji dostępności (W-01).<br/><br/>
...
8. **W-08. Dokumenty. Dostawca opisze, w jaki sposób zapewni, że wszelkie treści nieinternetowe generowane przez system będą spełniać wymogi dostępności. Dostawca określi również, w jaki sposób zapewniana jest dostępność dokumentów generowanych automatycznie oraz komunikacji systemowej.**<br/><br/>
