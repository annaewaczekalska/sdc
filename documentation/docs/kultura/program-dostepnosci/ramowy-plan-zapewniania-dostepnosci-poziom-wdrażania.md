---
id: ramowy-plan-zapewniania-dostepnosci-poziom-wdrażania
...
*wersja dla organizacji wchodzącej w etap wdrażania rozwiązań systemowych*
...
- Prowadzenie wewnętrznych cyklicznych komunikatów edukacyjnych dot. dostępności.  
- Uspójnienie zasad obsługi próśb o dostęp alternatywny.
...
### Działania
- Ustanowienie punktu kontaktowego (Biuro/Koordynator ds. dostępności cyfrowej).  
- Opracowanie i publikacja opisanych ścieżek wsparcia dla użytkowników i pracowników.  
- Uruchomienie rejestru zgłoszeń problemów z dostępnością – integracja z procedurą reakcji.  
- Włączenie działu IT oraz innych komórek do udzielania wsparcia II i III linii.  
- Zapewnienie dostępnych kanałów komunikacji (tekst, głos, wideo z napisami, komunikacja asynchroniczna).  
- Monitorowanie czasu reakcji oraz jakości udzielanego wsparcia.
...
### Działania
- Weryfikacja i uzupełnienie zakresów obowiązków o zadania związane z dostępnością cyfrową.  
- Określenie ról (np. autor treści, redaktor, tester, administrator, koordynator).  
- Powołanie międzywydziałowego zespołu ds. dostępności cyfrowej.  
- Zapewnienie procedury zastępstw dla kluczowych ról.  
- Rozpoczęcie procesu planowania ścieżek kompetencyjnych i mikropoświadczeń dla pracowników.  
- Dokumentowanie udziału pracowników w działaniach na rzecz dostępności.
...
### Działania
- Przeprowadzenie diagnozy kompetencji dla wybranych ról.  
...
### Działania
- Wdrożenie podstawowego procesu zapewniania dostępności w nowych projektach (od koncepcji do utrzymania).  
- Doprecyzowanie etapów wytwarzania treści: projektowanie, tworzenie, testy, publikacja, aktualizacje.  
...
- Prowadzenie działań budujących kulturę dostępności: kampanie wewnętrzne, komunikaty, prezentacje, spotkania zespołów, świętowanie sukcesów.
